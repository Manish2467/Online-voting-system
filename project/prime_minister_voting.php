...
<body>
    ...
    <div class="candidates-container">
        ...
        // Fetch data from the candidates table for the position "prime minister"
        $sql = "SELECT name, votes, image FROM candidates WHERE position = 'prime minister'";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<form method="POST" action="store_voteprime.php">
            ...
            echo "<p class='no-candidates'>No candidates found for the position of Prime Minister.</p>";
        }
